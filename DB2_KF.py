...
def KF_Analysis(DB):
    ...
    low1, high1 = 81.998, 92.1
    low2, high2 = 83.9677, 91.67
    low3, high3 = 84.7575, 93.34
    low4, high4 = 85.6484, 95.89
    low5, high5 = 83.6363, 94.9
    low6, high6 = 85.7657, 96.90
    low7, high7 = 82.5656, 96.80
    low8, high8 = 87.7678, 98.3
...
a= np.load("Analysis/KF_Analysis/DB1/ACC_2.npy")
print(a)
b=np.load("Analysis/KF_PERF/Concated_epochs/DB1/metrics_epochs_500.npy")
print(b)